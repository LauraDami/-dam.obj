...
public class Grupo {
	...
	public String toString () {
		...
		if (discografia.isEmpty()==true) {
			return "\n"+representante+" representa al grupo '"+nombre+"' procedientes de "+pais+". Este grupo aun no tiene discografÃ­a."+"\n\n";
		}else {
	...
	/**
	 * Metodo creado para añadir un disco nuevo a una discografia
	 */
