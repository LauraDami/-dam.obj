...
public class Operaciones {
	...
	/**
	 * Método para añadir un grupo al treemap, añadimos el try catch para que no de error si se mete algún datos que no sea numérico
	 * por teclado cuando lo que tenemos que recoger es un número
	 * @param grupos
	 */
	...
	/**
	 * Método para eliminar un grupo del treemap
	 * @param grupos
	 * @return
	 */
